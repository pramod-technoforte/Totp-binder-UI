		...
		<section className="text-gray-600 mt-4 body-font ">
			<div className="container flex mx-auto px-5 md:flex-row flex-col ">
				...
				<div className="lg:flex-grow lg:px-24 md:px-16 flex flex-col">
					{loading && <p className="text-center flex items-center justify-center h-screen">Loading...</p>}
					{error && <p className="text-center flex items-center justify-center h-screen">{error}</p>}
					{!loading && !error && (
