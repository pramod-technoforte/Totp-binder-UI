...
const uibaseUrl =
  window._env_.ESIGNET_UI_BASE_URL ?? "https://esignet.onpremdev.idencode.link";
const authorizeEndpoint = "/authorize";
const redirect_uri =
  window._env_.REDIRECT_URI ??
  "https://totp-binder-service.onpremdev.idencode.link/qrcode";
const totpBinderServiceUrl =
  window._env_.TOTP_BINDER_SERVICE_URL ??
...
const userProfileClaims =
  window._env_.USER_PROFILE_CLAIMS ??
